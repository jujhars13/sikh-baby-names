...
Promise.resolve()
  ...
  .then(data => {
    ...
    let transliterationSentence = data[0].transliteration.split(' ');
    let word = transliterationSentence.reduce(accumulator, currentValue => { return w.startsWith(str) });
    console.log(transliterationSentence, word);
