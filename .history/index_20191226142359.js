...
Promise.resolve()
  ...
  .then(data => {
    ...
    const transliterationPosition = fields.indexOf('transliteration');
    let transliterationSentence = data[1][transliterationPosition];
    console.log(transliterationSentence);
    console.log(transliterationPosition);
